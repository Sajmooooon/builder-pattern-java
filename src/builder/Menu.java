...
public class Menu {
    ...
    private static void selectPizzaFromMenu(Pizza.Builder builder, Director director, int choice){
        ...
        switch (choice) {
            case 1 -> director.setMargarita(builder);
            case 2 -> director.setCardinale(builder);
            case 3 -> director.setDiavolo(builder);
            case 4 -> director.setHawai(builder);
            case 5 -> director.setSalami(builder);
            case 6 -> director.setAllaMexicana(builder);
            case 7 -> director.setAlTonno(builder);
            default -> {
            }
        }
    }
